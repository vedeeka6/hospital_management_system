...
$sql="select * from doctor where ID='".$username."' AND password= '".$password."'";
$data=mysqli_connect($host,$user,$password,$db,"3308");
...
<table>
		<form><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>
			<u><h2 style="text-align: center; color: #23304a; ">DOCTOR VIEW</h2></u>
		</form>
		<tr>
		...
		$query="SELECT * FROM doc_view WHERE ID='$username'";
